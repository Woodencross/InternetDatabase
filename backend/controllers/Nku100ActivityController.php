...
use Yii;
use backend\models\Nku100Activity;
use backend\models\Nku100ActivitySearch;
...
class Nku100ActivityController extends Controller
{
    ...
    /**
     * Creates a new Nku100Activity model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new Nku100Activity();

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'id' => $model->NKU100_activity_id]);
        }
    ...
    /**
     * Updates an existing Nku100Activity model.
    ...
    /**
     * Deletes an existing Nku100Activity model.
