 ...
 * @property string $NKU100_member_photo 成员照片
...
class Nku100Member extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['NKU100_member_id', 'NKU100_member_name', 'NKU100_member_sex', 'NKU100_member_photo', 'NKU100_member_college', 'NKU100_member_hometown'], 'required'],
            [['NKU100_member_id'], 'integer'],
            [['NKU100_member_photo'], 'string'],
    ...
    /**
     * {@inheritdoc}
     * @return Nku100MemberQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new Nku100MemberQuery(get_called_class());
    }
}
