...
class Nku100MemberSearch extends Nku100Member
{
    ...
    public function rules()
    {
        return [
            ...
            [['NKU100_member_name', 'NKU100_member_sex', 'NKU100_member_photo', 'NKU100_member_college', 'NKU100_member_hometown', 'NKU100_member_sign'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'NKU100_member_name', $this->NKU100_member_name])
            ...
            ->andFilterWhere(['like', 'NKU100_member_photo', $this->NKU100_member_photo])
